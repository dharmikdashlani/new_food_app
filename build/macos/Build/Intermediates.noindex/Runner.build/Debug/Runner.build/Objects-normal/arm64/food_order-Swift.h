...
#ifndef FOOD_ORDER_SWIFT_H
#define FOOD_ORDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="food_order",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10food_order11AppDelegate")
...
SWIFT_CLASS("_TtC10food_order17MainFlutterWindow")
